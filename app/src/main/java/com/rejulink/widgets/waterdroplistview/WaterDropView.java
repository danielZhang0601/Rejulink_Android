package com.rejulink.widgets.waterdroplistview;

/**
 * Created by zxd on 15/7/18.
 */
...
import com.rejulink.utils.BitmapUtil;
...
public class WaterDropView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        arrowBitmap = BitmapUtil.drawableToBitmap(drawable);

...
import com.rejulink.natives.NativePlayer;
 ...
 */
public class ZSurfaceView extends GLSurfaceView {
    ...
    private static class ConfigChooser implements GLSurfaceView.EGLConfigChooser {
        ...
        private void printConfigs(EGL10 egl, EGLDisplay display,
            ...
            L.d(String.format("%d configurations", numConfigs));
            for (int i = 0; i < numConfigs; i++) {
                L.d(String.format("Configuration %d:\n", i));
    ...
    private static class Renderer implements GLSurfaceView.Renderer {
        public void onDrawFrame(GL10 gl) {
            NativePlayer.onNativeDrawFrame();
        }
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            NativePlayer.onNativeSurfaceCreated();
        }
    }
